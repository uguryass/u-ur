...
<table style="border: 1px solid #000000;width: 752px" align="center">
 <tr>
  <td style="font-family: 'Times New Roman', Times, serif;font-size: 17pt;text-align: center;width: 537; color: #2214B9;border-style: solid;border-width: 1px; height: 350px;">
   <textarea readonly="readonly" name="txtchat" style="width: 581px; color: #000000; height: 365px; background-color: #F4F8D1; font-family: 'times New Roman', Times, serif; font-size: 12pt;"><?php echo "$room chat odasına hoşgeldiniz...\n$contents"?> </textarea>
  </td>
...
<table style="border: 1px solid #000000;width: 452px" align="center">
 ...
 <tr>
  ...
  <option selected="">Turuncu</option>
  <option>Yesil</option>
  </select></td>
 </tr>
 <tr>
  ...
  <input name="enSubmit" style="width: 118px; height: 63px; font-size: 30pt; font-family: 'Times New Roman', Times, serif; color: #19B024;" type="submit" value="Odaya gir!"></td>
 </tr>
</table>
</form>
<?php
